 ...
 * @author User
 */
public class CourseGrades2TA extends javax.swing.JFrame {


    /**
     * Creates new form CourseGrades
     */
    public CourseGrades2TA() {
        initComponents();
    ...
    //You must implement this function to check number of assignments dynamically, if it is 1 assignment assigned to this TA
    //then add one column only to the table labeled by Assignment 1, if they were two assignments assigned 
    //to this TA, then add 2 columns to the table which are labeled by Assignment 1, and Assignment 2.
    public void addColumns(int numberOfAssignments) {
        if(numberOfAssignments == 1) {
            //add one column called Assignment1 to store students' grades in it.
        }
        else if(numberOfAssignments == 2) {
            //add two columns called Assignment1 to store students' grades in it.
        }
    }
    ...
    private void initComponents() {
        ...
        jTable_Grades.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "                   Student ID", "                   Student Name", "                   Assignment 2"
            }
        ));
...
//If you need to display some warning you could do the following
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CourseGrades2TA().setVisible(true);
            }
        });
    }
